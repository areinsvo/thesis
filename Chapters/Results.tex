...
%        \begin{tabular}{ |c|c|c|c|c|c|}
    ...
    \begin{tabular}{ |c|c|c|c|c|}
        \hline
  %      $\ETmiss$ (GeV) & Exp. QCD & Exp. EWK &  Exp. Z$\gamma\gamma$ &Total Exp. & Observed \\ [0.5ex]
  %      \hline
  %      $100 - 115$ & ${101.0}^{+46.0}_{-44.8}$ & 8.0 $\pm$ 2.5  & 1.3 $\pm$ 0.6 & ${ 110.3 }^{+25.9 }_{- 23.8 }$ & 65  \\
  %      $115 - 130$ & ${60.6}^{+ 36.7}_{-35.3}$ & 5.4 $\pm$ 1.7 & 1.1 $\pm$ 0.6 & ${ 67.1 }^{+22.7 }_{- 20.4 }$ & 26 \\
   %     $130 - 150$ & ${19.8}^{+ 19.1}_{-16.0}$ & 4.7 $\pm$ 1.5 & 1.1 $\pm$ 0.6 & ${ 25.7 }^{+16.1 }_{- 12.3 }$ & 17 \\
   %     $150 - 185$ & ${12.1}^{+ 10.5}_{-8.3}$  & 3.9 $\pm$ 1.2 & 1.3 $\pm$ 0.7 & ${ 17.3 }^{+8.3 }_{- 5.5 }$ & 13 \\
    %    $185 -  250$& ${2.5}^{+ 6.1}_{-2.5}$ & 3.4 $\pm$ 1.1 & 1.3 $\pm$ 0.6 & ${ 7.2 }^{+6.0 }_{- 2.5 }$ & 8  \\
     %   $\geq 250$  & ${13.4}^{+ 21.5}_{-13.4}$ & 2.0 $\pm$ 0.7 & 1.1 $\pm$ 0.5 & ${ 16.5 }^{+19.8 }_{- 12.4 }$ & 10 \\
...
In the bulk of the distribution, gluino masses below 1.87 TeV and squark masses below 
