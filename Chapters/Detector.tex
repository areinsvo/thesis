...
%Yutaro: An interpolation of the signal amplitudes gives a spacial resolution of 15-20 ?m, (because charge is shared between several pixels due to the geometry and the magnetic field)
