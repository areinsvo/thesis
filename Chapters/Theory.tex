...
Finally, the only particle not included in Table~\ref{tab:fermions} or \ref{tab:bosons} is the Higgs boson. The Higgs boson was discovered by the CMS and ATLAS collaborations in 2012 \cite{ATLASHiggs,CMSHiggs}. %and is responsible for EWSB. 
...
In gauge-mediated supersymmetry breaking (GMSB)~\cite{Fayet:1977vd, Fayet:1979yb, Fayet:1986zc, Dine:1993yw, Dine:1994vc,                                                   
