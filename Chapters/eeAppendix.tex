...
\begin{table}[ht]
  ...
  \begin{tabular}{|>{\centering\arraybackslash}m{0.9\linewidth}|}
    ...
    % \justify{MC samples used to remove contributions to the $ee$ control sample from processes with real \ETmiss.}
\end{table}
...
{\ETmiss distributions of the candidate sample and the reweighted $ee$ sample.
