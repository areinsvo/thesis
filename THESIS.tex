...
In GMSB models, the lightest supersymmetric particle is the gravitino, and the next-to-lightest supersymmetric particle is often taken to be the neutralino. The neutralino can decay to a photon and a gravitino, leading to final state signatures with one or more photons and significant $E_{\mathrm{T}}^{\text{miss}}$. 
...
Gluino masses below 1.87 TeV and squark masses below 1.60 TeV are excluded at a 95\% confidence level.
  \end{abstract}
...
\include{Chapters/eeAppendix}
\include{Chapters/2DAppendix}
